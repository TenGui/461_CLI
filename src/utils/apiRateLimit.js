...
var RateLimiter = /** @class */ (function () {
    ...
    RateLimiter.prototype.Settoken = function (token) {
        this.token = token;
    };
    RateLimiter.prototype.getGitHubInfo = function (url, params) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.githubApi.get("".concat(this.github_api).concat(url), {
                                headers: {
