...
function GetDetailsFromNPM(url) {
    return __awaiter(this, void 0, void 0, function () {
        var packagename, data, datasplit, repo;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, fetch("https://registry.npmjs.org/".concat(packagename))
                            ...
                            .then(function (data) { return data.repository.url; })];
                case 1:
                    data = _a.sent();
                    datasplit = data.split("/");
                    repo = datasplit.pop().split(".")[0];
                    return [2 /*return*/, [datasplit.pop(), repo]];
            }
        });
    });
}
