...
function PackageByNameDelete(name, xAuthorization) {
    return __awaiter(this, void 0, void 0, function () {
        var packageNameToDelete, getIdsQuery;
        var _this = this;
        return __generator(this, function (_a) {
            packageNameToDelete = name;
            getIdsQuery = 'SELECT ID FROM PackageMetadata WHERE Name = ?';
            db.query(getIdsQuery, [packageNameToDelete], function (err, results) { return __awaiter(_this, void 0, void 0, function () {
                var packageIds, _i, packageIds_1, id, _a, deleteResult, deleteFields, deleteError_1;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            if (err) {
                                console.error(err);
                                return [2 /*return*/, (0, writer_1.respondWithCode)(499)];
                            }
                            if (results.length === 0) {
                        ...
                        case 1:
                            ...
                            _b.label = 2;
                        case 2:
                            if (!(_i < packageIds_1.length)) return [3 /*break*/, 5];
                            id = packageIds_1[_i];
                            return [4 /*yield*/, promisePool.execute('CALL PackageDelete(?)', [id])];
                        case 3:
                        ...
                        case 4:
                            _i++;
                            return [3 /*break*/, 2];
                        case 5: return [2 /*return*/, (0, writer_1.respondWithCode)(200)]; // OK
                        case 6:
                            deleteError_1 = _b.sent();
                            console.error(deleteError_1);
