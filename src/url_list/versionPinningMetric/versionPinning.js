...
function get_version_pin_score(url) {
            ...
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    axios_1.default.get(apiUrl)
                        ...
                        if (response.status === 200) {
                            ...
                            //regexes 
                            var fullPinnedEX = /^[0-9]*\.[0-9]*\.[0-9]*/;
                            var majorMinorEX = /^[0-9]*\.[0-9]*\.[0-9]*/;
                            //initialize counts 
                            var count = 0;
                            var fullPinned = 0;
                            var majorMinor = 0;
                            for (var i in packageJson.dependencies) {
                                var curVer = packageJson.dependencies[i];
                                count += 1;
                            ...
                            var score = void 0;
                            var correctlyPinned = (majorMinor + fullPinned);
                            //calculate score
                            if (count == 0)
                                score = 1;
                            else
