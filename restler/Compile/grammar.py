...
request = requests.Request([
    ...
    "metadata":
        {
            "Name":
                """),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Name"]),
    primitives.restler_static_string("""
            ,
            "Version":"""),
    ...
    primitives.restler_static_string(""",
            "ID":
                """),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["ID"]),
    primitives.restler_static_string("""
        }
    ,
    "data":
        {
            "Content":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["Content"]),
    primitives.restler_static_string(""",
            "URL":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["URL"]),
    primitives.restler_static_string(""",
            "JSProgram":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["JSProgram"]),
    primitives.restler_static_string("""
        }
    }"""),
    primitives.restler_static_string("\r\n"),
...
# Endpoint: /addUser, method: Post
request = requests.Request([
    primitives.restler_static_string("POST "),
    primitives.restler_basepath(""),
    primitives.restler_static_string("/"),
    primitives.restler_static_string("addUser"),
    primitives.restler_static_string(" HTTP/1.1\r\n"),
    primitives.restler_static_string("Accept: application/json\r\n"),
    primitives.restler_static_string("Host: \r\n"),
    primitives.restler_refreshable_authentication_token("authentication_token_tag"),
...
# Endpoint: /loginUser, method: Post
request = requests.Request([
    primitives.restler_static_string("POST "),
    primitives.restler_basepath(""),
    primitives.restler_static_string("/"),
    primitives.restler_static_string("loginUser"),
    primitives.restler_static_string(" HTTP/1.1\r\n"),
    primitives.restler_static_string("Accept: application/json\r\n"),
    primitives.restler_static_string("Host: \r\n"),
    primitives.restler_refreshable_authentication_token("authentication_token_tag"),
...
request = requests.Request([
    ...
    primitives.restler_static_string("""
    "user":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["ece30861defaultadminuser"]),
    primitives.restler_static_string(""",
    "pass":"""),
    primitives.restler_fuzzable_string("fuzzstring", quoted=True, examples=["1234password"]),
    primitives.restler_static_string(""",
    "canSearch":"""),
